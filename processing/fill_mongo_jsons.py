...
input_file_dir='./SOCIAL_COMPUTING/INPUT_FILES3/'
outfile_folder='C2'
...
all_lines=0
exception_count=0
geo_in_india=open('./SOCIAL_COMPUTING/OUTPUT_FILES/'+outfile_folder+'/GEOin.txt','w')
geo_out_india=open('./SOCIAL_COMPUTING/OUTPUT_FILES/'+outfile_folder+'/GEOout.txt','w')
for file in file_arr:
	outfile_with_location=open('./SOCIAL_COMPUTING/OUTPUT_FILES/'+outfile_folder+'/'+file,'w')
	outfile_without_location=open('./SOCIAL_COMPUTING/OUTPUT_FILES/'+outfile_folder+'/'+'_NOT_'+file,'w')
